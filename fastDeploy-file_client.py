...
#python fastDeploy-file_client.py --dir test_data --ext jpg --url https://api.sightengine.com/1.0/check.json?&models=nudity
print(requests.post(args.url, files={"data": data},).json())